...
class DbusClient : public QObject
{
    ...
    Q_PROPERTY(int engineTemperatureRange READ engineTemperatureRange WRITE setEngineTemperatureRange NOTIFY engineTemperatureRangeChanged FINAL)
...
public:
    ...
    Q_INVOKABLE void setEngineTemperatureRange(int newEngineTemperatureRange);
...
signals:
    ...
    void engineTemperatureRangeChanged();
