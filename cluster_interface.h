 ...
 * Command line was: qdbusxml2cpp -m -p cluster_interface /home/sruthisathyan/Documents/Simulator 1/Simulator/myservice.xml
 *
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> setRpmStartingAndEndingRange(int rpmStartingRange, int rpmEndingRange)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(rpmStartingRange) << QVariant::fromValue(rpmEndingRange);
        return asyncCallWithArgumentList(QStringLiteral("setRpmStartingAndEndingRange"), argumentList);
    }

    inline QDBusPendingReply<> setSpeedStartingAndEndingRange(int speedStartingRange, int speedEndingRange)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(speedStartingRange) << QVariant::fromValue(speedEndingRange);
        return asyncCallWithArgumentList(QStringLiteral("setSpeedStartingAndEndingRange"), argumentList);
    }

    inline QDBusPendingReply<> setEngineTemperatureRange(int tempRange)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(tempRange);
        return asyncCallWithArgumentList(QStringLiteral("setTempRange"), argumentList);
    }
